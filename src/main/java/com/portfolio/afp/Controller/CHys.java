...
public class CHys {
    ...
    public ResponseEntity<?> create(@RequestBody dtoHys dtohys) {
        ...
        {
            return new ResponseEntity(new Mensaje("La habilidad mencionada ya esta en uso"), HttpStatus.BAD_REQUEST);
        }
