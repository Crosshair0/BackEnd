...
public class PersonaController {
    ...
    public ResponseEntity<?> create(@RequestBody dtoPersona dtopersona) {
        ...
        if (StringUtils.isBlank(dtopersona.getDescripcionE()))
        {
        ...
        if (personaService.existsByDescripcionE(dtopersona.getDescripcionE()))
        {
